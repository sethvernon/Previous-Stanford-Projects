...
//  AVFoundationDemo
//
//  Created by Seth Vernon on 4/13/12.
...
- (void) captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection 
{
    ...
    for(CIFaceFeature * face in features) {
        ...
        // set the glasses position based on mouth position
            ...
            self.glasses.center = CGPointMake(scaley*eyeCenter.y-self.glasses.bounds.size.height/
                                              4.0, scalex*(eyeCenter.x));
        ...
        // set size based on distance between two eyes:
